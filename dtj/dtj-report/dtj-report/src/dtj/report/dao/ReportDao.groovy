...
class ReportDao extends BaseMdbUtils {
    ...
    void generateReportPO_4(Map<String, Object> params) {
        ...
        if (mapData.get("59") && mapData.get("59").get("59"))
            cell.setCellValue(mapData.get("59").get("59"))
        //60
        row = destSheet.getRow(46)
        cell = row.getCell(4)
        if (mapData.get("60") && mapData.get("60").get("75c"))
            cell.setCellValue(mapData.get("60").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("60") && mapData.get("60").get("75z"))
            cell.setCellValue(mapData.get("60").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("60") && mapData.get("60").get("65c"))
            cell.setCellValue(mapData.get("60").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("60") && mapData.get("60").get("65z"))
            cell.setCellValue(mapData.get("60").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("60") && mapData.get("60").get("60"))
            cell.setCellValue(mapData.get("60").get("60"))
        cell = row.getCell(9)
        if (mapData.get("60") && mapData.get("60").get("60"))
            cell.setCellValue(mapData.get("60").get("60"))
        //62
        row = destSheet.getRow(47)
        cell = row.getCell(4)
        if (mapData.get("62") && mapData.get("62").get("75c"))
            cell.setCellValue(mapData.get("62").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("62") && mapData.get("62").get("75z"))
            cell.setCellValue(mapData.get("62").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("62") && mapData.get("62").get("65c"))
            cell.setCellValue(mapData.get("62").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("62") && mapData.get("62").get("65z"))
            cell.setCellValue(mapData.get("62").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("62") && mapData.get("62").get("62"))
            cell.setCellValue(mapData.get("62").get("62"))
        cell = row.getCell(9)
        if (mapData.get("62") && mapData.get("62").get("62"))
            cell.setCellValue(mapData.get("62").get("62"))
        //65
        row = destSheet.getRow(48)
        cell = row.getCell(4)
        if (mapData.get("65") && mapData.get("65").get("75c"))
            cell.setCellValue(mapData.get("65").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("65") && mapData.get("65").get("75z"))
            cell.setCellValue(mapData.get("65").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("65") && mapData.get("65").get("65c"))
            cell.setCellValue(mapData.get("65").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("65") && mapData.get("65").get("65z"))
            cell.setCellValue(mapData.get("65").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("65") && mapData.get("65").get("65"))
            cell.setCellValue(mapData.get("65").get("65"))
        cell = row.getCell(9)
        if (mapData.get("65") && mapData.get("65").get("65"))
            cell.setCellValue(mapData.get("65").get("65"))
        //66
        row = destSheet.getRow(49)
        cell = row.getCell(4)
        if (mapData.get("66") && mapData.get("66").get("75c"))
            cell.setCellValue(mapData.get("66").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("66") && mapData.get("66").get("75z"))
            cell.setCellValue(mapData.get("66").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("66") && mapData.get("66").get("65c"))
            cell.setCellValue(mapData.get("66").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("66") && mapData.get("66").get("65z"))
            cell.setCellValue(mapData.get("66").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("66") && mapData.get("66").get("66"))
            cell.setCellValue(mapData.get("66").get("66"))
        cell = row.getCell(9)
        if (mapData.get("66") && mapData.get("66").get("66"))
            cell.setCellValue(mapData.get("66").get("66"))
        //69
        row = destSheet.getRow(50)
        cell = row.getCell(4)
        if (mapData.get("69") && mapData.get("69").get("75c"))
            cell.setCellValue(mapData.get("69").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("69") && mapData.get("69").get("75z"))
            cell.setCellValue(mapData.get("69").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("69") && mapData.get("69").get("65c"))
            cell.setCellValue(mapData.get("69").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("69") && mapData.get("69").get("65z"))
            cell.setCellValue(mapData.get("69").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("69") && mapData.get("69").get("69"))
            cell.setCellValue(mapData.get("69").get("69"))
        cell = row.getCell(9)
        if (mapData.get("69") && mapData.get("69").get("69"))
            cell.setCellValue(mapData.get("69").get("69"))
        //70
        row = destSheet.getRow(52)
        cell = row.getCell(4)
        if (mapData.get("70") && mapData.get("70").get("75c"))
            cell.setCellValue(mapData.get("70").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("70") && mapData.get("70").get("75z"))
            cell.setCellValue(mapData.get("70").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("70") && mapData.get("70").get("65c"))
            cell.setCellValue(mapData.get("70").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("70") && mapData.get("70").get("65z"))
            cell.setCellValue(mapData.get("70").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("70") && mapData.get("70").get("70"))
            cell.setCellValue(mapData.get("70").get("70"))
        cell = row.getCell(9)
        if (mapData.get("70") && mapData.get("70").get("70"))
            cell.setCellValue(mapData.get("70").get("70"))
        //74
        row = destSheet.getRow(53)
        cell = row.getCell(4)
        if (mapData.get("74") && mapData.get("74").get("75c"))
            cell.setCellValue(mapData.get("74").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("74") && mapData.get("74").get("75z"))
            cell.setCellValue(mapData.get("74").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("74") && mapData.get("74").get("65c"))
            cell.setCellValue(mapData.get("74").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("74") && mapData.get("74").get("65z"))
            cell.setCellValue(mapData.get("74").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("74") && mapData.get("74").get("74"))
            cell.setCellValue(mapData.get("74").get("74"))
        cell = row.getCell(9)
        if (mapData.get("74") && mapData.get("74").get("74"))
            cell.setCellValue(mapData.get("74").get("74"))
        //79
        row = destSheet.getRow(54)
        cell = row.getCell(4)
        if (mapData.get("79") && mapData.get("79").get("75c"))
            cell.setCellValue(mapData.get("79").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("79") && mapData.get("79").get("75z"))
            cell.setCellValue(mapData.get("79").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("79") && mapData.get("79").get("65c"))
            cell.setCellValue(mapData.get("79").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("79") && mapData.get("79").get("65z"))
            cell.setCellValue(mapData.get("79").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("79") && mapData.get("79").get("79"))
            cell.setCellValue(mapData.get("79").get("79"))
        cell = row.getCell(9)
        if (mapData.get("79") && mapData.get("79").get("79"))
            cell.setCellValue(mapData.get("79").get("79"))
        //85
        row = destSheet.getRow(56)
        cell = row.getCell(4)
        if (mapData.get("85") && mapData.get("85").get("75c"))
            cell.setCellValue(mapData.get("85").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("85") && mapData.get("85").get("75z"))
            cell.setCellValue(mapData.get("85").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("85") && mapData.get("85").get("65c"))
            cell.setCellValue(mapData.get("85").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("85") && mapData.get("85").get("65z"))
            cell.setCellValue(mapData.get("85").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("85") && mapData.get("85").get("85"))
            cell.setCellValue(mapData.get("85").get("85"))
        cell = row.getCell(9)
        if (mapData.get("85") && mapData.get("85").get("85"))
            cell.setCellValue(mapData.get("85").get("85"))
        //86
        row = destSheet.getRow(57)
        cell = row.getCell(4)
        if (mapData.get("86") && mapData.get("86").get("75c"))
            cell.setCellValue(mapData.get("86").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("86") && mapData.get("86").get("75z"))
            cell.setCellValue(mapData.get("86").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("86") && mapData.get("86").get("65c"))
            cell.setCellValue(mapData.get("86").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("86") && mapData.get("86").get("65z"))
            cell.setCellValue(mapData.get("86").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("86") && mapData.get("86").get("86"))
            cell.setCellValue(mapData.get("86").get("86"))
        cell = row.getCell(9)
        if (mapData.get("86") && mapData.get("86").get("86"))
            cell.setCellValue(mapData.get("86").get("86"))
        //99
        row = destSheet.getRow(59)
        cell = row.getCell(4)
        if (mapData.get("99") && mapData.get("99").get("75c"))
            cell.setCellValue(mapData.get("99").get("75c"))
        cell = row.getCell(5)
        if (mapData.get("99") && mapData.get("99").get("75z"))
            cell.setCellValue(mapData.get("99").get("75z"))
        cell = row.getCell(6)
        if (mapData.get("99") && mapData.get("99").get("65c"))
            cell.setCellValue(mapData.get("99").get("65c"))
        cell = row.getCell(7)
        if (mapData.get("99") && mapData.get("99").get("65z"))
            cell.setCellValue(mapData.get("99").get("65z"))
        cell = row.getCell(8)
        if (mapData.get("99") && mapData.get("99").get("99"))
            cell.setCellValue(mapData.get("99").get("99"))
        cell = row.getCell(9)
        if (mapData.get("99") && mapData.get("99").get("99"))
            cell.setCellValue(mapData.get("99").get("99"))
        //
