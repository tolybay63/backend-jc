...
//        map.put("periodType", 31)
    ...
    void testSaveParameterLog() {
        ...
        map.put("ParamsLimit", 10)
        map.put("ParamsLimitMax", 9)
        map.put("ParamsLimitMin", null)
        map.put("fvOutOfNorm", 1074)
        map.put("pvOutOfNorm", 1299)
        map.put("objUser", 1003)
        map.put("pvUser", 1087)
        map.put("fullNameUser", "Канат С.")
