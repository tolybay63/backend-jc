...
class UtEntityTranslate extends BaseMdbUtils {
    ...
    void insertToTableLang(String nameTable, Map<String, Object> params) {
    ...
    void updateTableLang(String nameTable, Map<String, Object> params) throws Exception {
